...
--------------------------------------------------------
  ...
  CREATE TABLE "MAIN"."CLIENT" ("CLIENT_ID" NUMBER, "EMAIL" VARCHAR2(100) COLLATE "USING_NLS_COMP")  DEFAULT COLLATION "USING_NLS_COMP"
...
--------------------------------------------------------
  ...
  CREATE TABLE "MAIN"."COUNTRY_API_ERROR" ("SQLCODE" VARCHAR2(20) COLLATE "USING_NLS_COMP", "SQLERRMS" VARCHAR2(4000) COLLATE "USING_NLS_COMP", "LOCATION" VARCHAR2(400) COLLATE "USING_NLS_COMP", "OCCURE_DATE" TIMESTAMP (6) DEFAULT CURRENT_TIMESTAMP)  DEFAULT COLLATION "USING_NLS_COMP"
--------------------------------------------------------
--  DDL for Table DESTINATION
--------------------------------------------------------

  CREATE TABLE "MAIN"."DESTINATION" ("DESTINATION_ID" NUMBER(8,0), "COUNTRY_ISO_ID" CHAR(2) COLLATE "USING_NLS_COMP", "NAME" VARCHAR2(255) COLLATE "USING_NLS_COMP")  DEFAULT COLLATION "USING_NLS_COMP"
--------------------------------------------------------
--  DDL for Table OFFER
--------------------------------------------------------

  CREATE TABLE "MAIN"."OFFER" ("OFFER_ID" NUMBER, "TYPE_ID" NUMBER, "NAME" VARCHAR2(255) COLLATE "USING_NLS_COMP", "PRICE" NUMBER(7,2), "MINIMAL_PRICE" NUMBER(7,2), "DEPARTURE_DATE" DATE, "COMEBACK_DATE" DATE, "DESTINATION_ID" NUMBER, "DURATION" NUMBER GENERATED ALWAYS AS ("COMEBACK_DATE"-"DEPARTURE_DATE") VIRTUAL , "START_OFFER_DATE" DATE DEFAULT SYSDATE, "END_OFFER_DATE" DATE, "SPOTS_LEFT" NUMBER(4,0), "HAS_FREE_SPOTS" NUMBER GENERATED ALWAYS AS (CASE  WHEN "SPOTS_LEFT">0 THEN 1 ELSE 0 END) VIRTUAL )  DEFAULT COLLATION "USING_NLS_COMP"
--------------------------------------------------------
--  DDL for Table OFFER_PRICE_ARCHIVE
--------------------------------------------------------

  CREATE TABLE "MAIN"."OFFER_PRICE_ARCHIVE" ("OFFER_ID" NUMBER, "PRICE_DIFF" NUMBER(7,2))  DEFAULT COLLATION "USING_NLS_COMP"
--------------------------------------------------------
--  DDL for Table OFFER_TYPE
--------------------------------------------------------

  CREATE TABLE "MAIN"."OFFER_TYPE" ("TYPE_ID" NUMBER, "NAME" VARCHAR2(255) COLLATE "USING_NLS_COMP")  DEFAULT COLLATION "USING_NLS_COMP"
--------------------------------------------------------
--  DDL for Table RESERVATION
--------------------------------------------------------

  CREATE TABLE "MAIN"."RESERVATION" ("CLIENT_ID" NUMBER, "OFFER_ID" NUMBER, "CREATION_DATETIME" TIMESTAMP (6) DEFAULT CURRENT_TIMESTAMP, "PARTICIPANTS_NUM" NUMBER(2,0), "PRICE" NUMBER(8,2))  DEFAULT COLLATION "USING_NLS_COMP"
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE VIEW "MAIN"."AVAILABLE_OFFERS" ("OFFER_ID", "TYPE_ID", "TYPE_NAME", "NAME", "PRICE", "DEPARTURE_DATE", "COMEBACK_DATE", "DURATION", "DESTINATION_ID", "COUNTRY_NAME", "COUNTRY_REGION", "DESTINATION", "SPOTS_LEFT") DEFAULT COLLATION "USING_NLS_COMP"  AS SELECT 
    o.offer_id,
	t.type_id,
    t.name AS type_name,
	o.name,
...
SET DEFINE OFF;
Insert into MAIN.OFFER (OFFER_ID,TYPE_ID,NAME,PRICE,MINIMAL_PRICE,DEPARTURE_DATE,COMEBACK_DATE,DESTINATION_ID,DURATION,START_OFFER_DATE,END_OFFER_DATE,SPOTS_LEFT,HAS_FREE_SPOTS) values ('1','1','Safari','4800','4800',to_date('22/09/10','RR/MM/DD'),to_date('22/09/22','RR/MM/DD'),'6','12',to_date('22/05/23','RR/MM/DD'),to_date('22/08/01','RR/MM/DD'),'40','1');
Insert into MAIN.OFFER (OFFER_ID,TYPE_ID,NAME,PRICE,MINIMAL_PRICE,DEPARTURE_DATE,COMEBACK_DATE,DESTINATION_ID,DURATION,START_OFFER_DATE,END_OFFER_DATE,SPOTS_LEFT,HAS_FREE_SPOTS) values ('2','2','Visit Birmingham','900','900',to_date('22/07/12','RR/MM/DD'),to_date('22/07/22','RR/MM/DD'),'5','10',to_date('22/05/23','RR/MM/DD'),to_date('22/07/10','RR/MM/DD'),'0','0');
Insert into MAIN.OFFER (OFFER_ID,TYPE_ID,NAME,PRICE,MINIMAL_PRICE,DEPARTURE_DATE,COMEBACK_DATE,DESTINATION_ID,DURATION,START_OFFER_DATE,END_OFFER_DATE,SPOTS_LEFT,HAS_FREE_SPOTS) values ('3','3','Bahamas','4800','4800',to_date('23/01/25','RR/MM/DD'),to_date('23/02/14','RR/MM/DD'),'4','20',to_date('22/05/23','RR/MM/DD'),to_date('22/11/01','RR/MM/DD'),'85','1');
Insert into MAIN.OFFER (OFFER_ID,TYPE_ID,NAME,PRICE,MINIMAL_PRICE,DEPARTURE_DATE,COMEBACK_DATE,DESTINATION_ID,DURATION,START_OFFER_DATE,END_OFFER_DATE,SPOTS_LEFT,HAS_FREE_SPOTS) values ('4','3','Yucatan','2600','2600',to_date('22/10/15','RR/MM/DD'),to_date('22/10/30','RR/MM/DD'),'2','15',to_date('22/05/23','RR/MM/DD'),to_date('22/10/01','RR/MM/DD'),'130','1');
Insert into MAIN.OFFER (OFFER_ID,TYPE_ID,NAME,PRICE,MINIMAL_PRICE,DEPARTURE_DATE,COMEBACK_DATE,DESTINATION_ID,DURATION,START_OFFER_DATE,END_OFFER_DATE,SPOTS_LEFT,HAS_FREE_SPOTS) values ('5','4','Vermont','4780','2400',to_date('22/12/22','RR/MM/DD'),to_date('23/01/03','RR/MM/DD'),'3','12',to_date('22/05/23','RR/MM/DD'),to_date('22/12/01','RR/MM/DD'),'40','1');
Insert into MAIN.OFFER (OFFER_ID,TYPE_ID,NAME,PRICE,MINIMAL_PRICE,DEPARTURE_DATE,COMEBACK_DATE,DESTINATION_ID,DURATION,START_OFFER_DATE,END_OFFER_DATE,SPOTS_LEFT,HAS_FREE_SPOTS) values ('6','2','Warszawa','300','300',to_date('22/08/11','RR/MM/DD'),to_date('22/08/16','RR/MM/DD'),'1','5',to_date('22/05/23','RR/MM/DD'),to_date('22/08/01','RR/MM/DD'),'0','0');
REM INSERTING into MAIN.OFFER_PRICE_ARCHIVE
SET DEFINE OFF;
Insert into MAIN.OFFER_PRICE_ARCHIVE (OFFER_ID,PRICE_DIFF) values ('1','2700');
Insert into MAIN.OFFER_PRICE_ARCHIVE (OFFER_ID,PRICE_DIFF) values ('2','1600');
Insert into MAIN.OFFER_PRICE_ARCHIVE (OFFER_ID,PRICE_DIFF) values ('6','500');
Insert into MAIN.OFFER_PRICE_ARCHIVE (OFFER_ID,PRICE_DIFF) values ('3','450');
Insert into MAIN.OFFER_PRICE_ARCHIVE (OFFER_ID,PRICE_DIFF) values ('4','2500');
...
SET DEFINE OFF;
Insert into MAIN.RESERVATION (CLIENT_ID,OFFER_ID,CREATION_DATETIME,PARTICIPANTS_NUM,PRICE) values ('1','6',to_timestamp('22/05/24 13:40:51,750688000','RR/MM/DD HH24:MI:SSXFF'),'3','900');
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Trigger SPOTS_LEFT_CHK_TG
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "MAIN"."SPOTS_LEFT_CHK_TG" 
BEFORE INSERT OR UPDATE OF spots_left ON main.offer
    FOR EACH ROW
    BEGIN
        IF :new.spots_left < free_spots_chk(:new.offer_id) THEN
            RAISE_APPLICATION_ERROR(-20001, 'New spots left number is too low');
        END IF;
    END;
ALTER TRIGGER "MAIN"."SPOTS_LEFT_CHK_TG" ENABLE
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Function FREE_SPOTS_CHK
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE FUNCTION "MAIN"."FREE_SPOTS_CHK" (in_offer_id IN NUMBER) RETURN NUMBER AS 
ln_current_participants NUMBER;
BEGIN
  SELECT count(*) INTO ln_current_participants FROM main.reservation WHERE offer_id = in_offer_id;
  RETURN ln_current_participants;
EXCEPTION
    WHEN no_data_found THEN
    RETURN 0;
END free_spots_chk;
...
--------------------------------------------------------
  ...
  ALTER TABLE "MAIN"."DESTINATION" ADD CONSTRAINT "PK_DESTINATION" PRIMARY KEY ("DESTINATION_ID") USING INDEX  ENABLE
  ALTER TABLE "MAIN"."DESTINATION" ADD CONSTRAINT "DEST_NAME_UNQ" UNIQUE ("COUNTRY_ISO_ID", "NAME") USING INDEX  ENABLE
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "MAIN"."OFFER" ADD CONSTRAINT "PK_OFFER" PRIMARY KEY ("OFFER_ID") USING INDEX  ENABLE
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "MAIN"."CLIENT" ADD CONSTRAINT "PK_CLIENT" PRIMARY KEY ("CLIENT_ID") USING INDEX  ENABLE
  ALTER TABLE "MAIN"."CLIENT" ADD CONSTRAINT "EMAIL_UNQ" UNIQUE ("EMAIL") USING INDEX  ENABLE
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "MAIN"."OFFER_TYPE" ADD CONSTRAINT "PK_OFFER_TYPE" PRIMARY KEY ("TYPE_ID") USING INDEX  ENABLE
  ALTER TABLE "MAIN"."OFFER_TYPE" ADD CONSTRAINT "TYPE_NAME_UNQ" UNIQUE ("NAME") USING INDEX  ENABLE
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "MAIN"."RESERVATION" ADD CONSTRAINT "PK_RESERVATION" PRIMARY KEY ("CLIENT_ID", "OFFER_ID") USING INDEX  ENABLE
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "MAIN"."OFFER_PRICE_ARCHIVE" ADD CONSTRAINT "PK_OFFER_PRICE_ARCHIVE" PRIMARY KEY ("OFFER_ID") USING INDEX  ENABLE
--------------------------------------------------------
--  Ref Constraints for Table OFFER
--------------------------------------------------------

  ALTER TABLE "MAIN"."OFFER" ADD CONSTRAINT "FK_OFFER_DESTINATION" FOREIGN KEY ("DESTINATION_ID") REFERENCES "MAIN"."DESTINATION" ("DESTINATION_ID") ON DELETE CASCADE ENABLE
  ALTER TABLE "MAIN"."OFFER" ADD CONSTRAINT "FK_OFFER_OFFER_TYPE" FOREIGN KEY ("TYPE_ID") REFERENCES "MAIN"."OFFER_TYPE" ("TYPE_ID") ON DELETE CASCADE ENABLE
--------------------------------------------------------
--  Ref Constraints for Table OFFER_PRICE_ARCHIVE
--------------------------------------------------------

  ALTER TABLE "MAIN"."OFFER_PRICE_ARCHIVE" ADD CONSTRAINT "FK_OFFER_PRICE_ARCHIVE" FOREIGN KEY ("OFFER_ID") REFERENCES "MAIN"."OFFER" ("OFFER_ID") ON DELETE CASCADE ENABLE
--------------------------------------------------------
--  Ref Constraints for Table RESERVATION
--------------------------------------------------------

  ALTER TABLE "MAIN"."RESERVATION" ADD CONSTRAINT "FK_RESERVATION_CLIENT" FOREIGN KEY ("CLIENT_ID") REFERENCES "MAIN"."CLIENT" ("CLIENT_ID") ON DELETE CASCADE ENABLE
  ALTER TABLE "MAIN"."RESERVATION" ADD CONSTRAINT "FK_RESERVATION_OFFER" FOREIGN KEY ("OFFER_ID") REFERENCES "MAIN"."OFFER" ("OFFER_ID") ON DELETE CASCADE ENABLE
